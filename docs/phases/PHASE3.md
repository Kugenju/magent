...
阶段 3 的能力已被阶段 4 的可靠性 runner 和结构化尝试报告复用；本文件保留阶段 3 的拓扑和并发语义，后续 checkpoint 语义见 [`PHASE5.md`](PHASE5.md)。
...
- [ ] 确认报告字段和 `../architecture/API.md` 一致
- [ ] 保留并记录并发基准结果
- [ ] 在 `ROADMAP.md` 中将阶段 3 标记为已完成

阶段 4 的详细方案见 [`PHASE4.md`](PHASE4.md)。
